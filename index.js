...
const config = {
    XBOT: '❉ASHURABOT❉', 
    instagram: 'https://instagram.com/ashurabot?igshid=3fkx1a6xmc3n', 
    nomer: 'wa.me/5527992752045',
    youtube: 'https://youtube.com/channel/UCAlJ_Uh5JcY6rJbvt0fkmxA', 
...
client.on('group-participants-update', async (anu) => {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			mess = {
				wait: '❬❗❭ 𝘼𝙂𝙐𝙍𝘿𝙀 𝙎𝙊 𝙈𝘼𝙄𝙎 𝙐𝙈 𝙋𝙊𝙐𝙌𝙐𝙄𝙉𝙃𝙊',
				success: '️❬ ✔ ❭ 𝙎𝙐𝘾𝙀𝙎𝙎𝙊 🖤',
				error: {
					stick: 'Yah gagal ;(, coba ulangi ^_^',
					Iv: '𝘿𝙀𝙎𝘾𝙐𝙇𝙋𝘼 𝙇𝙄𝙉𝙆 𝙉𝘼𝙊 𝙑𝘼𝙇𝙄𝘿𝙊☹️'
				},
				only: {
					group: '❬❗❭ 𝗚𝗥𝗢𝗨𝗣 𝗢𝗡𝗟𝗬 ',
					ownerG: '❬❗❭ 𝙎𝙊𝙈𝙀𝙉𝙏𝙀 𝘿𝙊𝙉𝙊 ',
          ...
          case 'ping':
            ...
            case 'kangcopet':
				...
				case 'ocr': 
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
						...
						reply('𝙚𝙣𝙫𝙞𝙖 𝙛𝙤𝙩𝙤 𝙘𝙤𝙢 𝙡𝙚𝙜𝙚𝙣𝙙𝙖 ${prefix}𝗼𝗰𝗿')
					}
					break
				case 'stiker': 
				case 'sticker':
            ...
            break	
				...
				case 'setprefix':
					...
					if (!isOwner) return reply(mess.only.ownerB)
					prefix = args[0]
					reply(`prefixo alterado com sucesso❤️ : ${prefix}`) 
					break 
				case 'hilih': 
				...
				case 'tiktokstalk':
					try {
						if (args.length < 1) return client.sendMessage(from, 'qual e o nome do  usuário ?', text, {quoted: mek})
						...
						reply('[𝗘𝗥𝗥𝗢𝗥] 𝙥𝙤𝙨𝙨𝙞𝙫𝙚𝙡𝙢𝙚𝙣𝙩𝙚 𝙤 𝙣𝙤𝙢𝙚 𝙙𝙚 𝙪𝙨𝙪𝙖𝙧𝙞𝙤 𝙚 𝙞𝙣𝙫𝙖𝙡𝙞𝙙𝙤')
					}
					break
				case 'fitnah':	
				case 'fake':          
               if (!isGroup) return reply(mess.only.group)
				...
				case 'clearall':
					...
					reply('𝙡𝙞𝙢𝙥𝙖𝙧 𝙩𝙪𝙙𝙤,𝙛𝙤𝙞 𝙗𝙚𝙢 𝙨𝙪𝙘𝙚𝙙𝙞𝙙𝙤  :)')
					break 
			       case 'block':
				 ...
				 client.chatRead (from)
					...
					client.sendMessage(from, `𝙥𝙚𝙙𝙞𝙙𝙤𝙨 𝙧𝙚𝙘𝙚𝙗𝙞𝙙𝙤𝙨, 𝙖𝙗𝙚𝙧𝙩𝙤𝙨 ${body.slice(9)}@c.us`, text)
				break
				case 'leave': 
				if (!isGroup) return reply(mess.only.group)
					if (!isOwner) return reply(mess.only.ownerB)
				await client.leaveGroup(from, '𝙩𝙘𝙝𝙖𝙪', groupId)
                    break
				case 'bc': 
					if (!isOwner) return reply(' *LU SIAPA* ?') 
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							client.sendMessage(_.jid, buff, image, {caption: `❮ 𝙢𝙚𝙣𝙨𝙖𝙜𝙚𝙢 𝙙𝙚 𝙩𝙧𝙖𝙣𝙨𝙢𝙞𝙨𝙨𝙖𝙤 ❯\n\n${body.slice(4)}`})
						}
						reply('𝙏𝙍𝘼𝙉𝙎𝙈𝙄𝙎𝙎𝘼𝙊 𝙎𝙐𝘾𝙀𝘿𝙄𝘿𝘼 ')
					} else {
						for (let _ of anu) {
							sendMess(_.jid, `❮ 𝙢𝙚𝙣𝙨𝙖𝙜𝙚𝙢 𝙙𝙚 𝙩𝙧𝙖𝙣𝙨𝙢𝙞𝙨𝙨𝙖𝙤 ❯\n\n${body.slice(4)}`)
						}
						reply('𝙏𝙍𝘼𝙉𝙎𝙈𝙄𝙎𝙎𝘼𝙊 𝙎𝙐𝘾𝙀𝘿𝙄𝘿𝘼 ')
					}
					break
			   	case 'setpp': 
                       ...
                       media = await client.downloadAndSaveMediaMessage(mek)
                        ...
                        reply('𝙢𝙪𝙙𝙖 𝙘𝙤𝙢 𝙨𝙪𝙘𝙚𝙨𝙨𝙤 𝙤 𝙞𝙘𝙤𝙣𝙚 𝙙𝙤 𝙜𝙧𝙪𝙥𝙤')
				...
				case 'add':
					...
					if (!isBotGroupAdmins) return reply(mess.only.Badmin)
					if (args[0] === 'buka') {
					    reply(`𝙂𝙧𝙪𝙥𝙤 𝙖𝙗𝙚𝙧𝙩𝙤 𝙘𝙤𝙢 𝙨𝙪𝙘𝙚𝙨𝙨𝙤`)
       ...
       client.sendMessage(from, 'Tuh nomer owner ku >_<, jangan spam atau ku block kamu',MessageType.text, { quoted: mek} )
           ...
           case 'demote':
					...
					if (!isGroupAdmins) return reply(mess.only.admin)
					if (!isBotGroupAdmins) return reply(mess.only.Badmin)
					if (mek.message.extendedTextMessage === undefined || mek.message.extendedTextMessage === null) return reply('𝙢𝙖𝙧𝙘𝙖 𝙖𝙡𝙫𝙤 𝙦𝙪𝙚 𝙫𝙤𝙘𝙚 𝙦𝙪𝙚𝙧 𝙗𝙖𝙣𝙞𝙧  𝙛𝙞𝙡𝙝𝙖 𝙙𝙖 𝙥𝙪𝙩𝙖!!!')
					mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
					if (mentioned.length > 1) {
						teks = ''
						for (let _ of mentioned) {
							teks += `𝙨𝙞𝙢, 𝙨𝙪𝙖 𝙥𝙤𝙨𝙞𝙘𝙖𝙤 𝙙𝙚 𝙖𝙙𝙢𝙞𝙣𝙞𝙨𝙩𝙧𝙖𝙙𝙤𝙧 𝙛𝙤𝙞 𝙧𝙚𝙢𝙤𝙫𝙞𝙙𝙖 𝙠𝙠𝙠𝙠𝙠𝙠!!!🏃 :\n`
							teks += `@_.split('@')[0]`
						}
						mentions(teks, mentioned, true)
						client.groupDemoteAdmin(from, mentioned)
					} else {
						mentions(`bem @${mentioned[0].split('@')[0]} 𝙨𝙪𝙖 𝙥𝙤𝙨𝙞𝙘𝙖𝙤 𝙙𝙚 𝙖𝙙𝙢𝙞𝙣𝙞𝙨𝙩𝙧𝙖𝙙𝙤𝙧 𝙛𝙤𝙞 𝙧𝙚𝙢𝙤𝙫𝙞𝙙𝙖 𝙠𝙨𝙠𝙨𝙠𝙨𝙠!!!🏃`, mentioned, true)
						client.groupDemoteAdmin(from, mentioned)
					}
					break
				case 'promote':
					...
					if (!isGroupAdmins) return reply(mess.only.admin)
					if (!isBotGroupAdmins) return reply(mess.only.Badmin)
					if (mek.message.extendedTextMessage === undefined || mek.message.extendedTextMessage === null) return reply('𝙈𝘼𝙍𝘾𝘼 𝘼 𝙋𝙀𝙎𝙎𝙊𝘼 𝙌𝙐𝙀 𝙑𝘾 𝙌𝙐𝙀𝙍 𝘽𝘼𝙉𝙄!❤️🤡!')
					mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
					if (mentioned.length > 1) {
						teks = ''
						for (let _ of mentioned) {
							teks += `𝙋𝘼𝙍𝘼𝘽𝙀𝙉𝙎 𝙈𝘼𝙉𝙊 𝙑𝘾 𝘼𝙂𝙍 𝙀 𝙐𝙈 𝙏𝘼𝙊 𝙎𝙊𝙉𝙃𝘼𝘿𝙊 𝘼𝘿𝙈𝙄𝙉!!!😳 (+_+) :\n`
							teks += `@_.split('@')[0]`
						}
						mentions(teks, mentioned, true)
						client.groupMakeAdmin(from, mentioned)
					} else {
						mentions(`PARABENS😳 @${mentioned[0].split('@')[0]} 𝙈𝘼𝙉𝙊 𝙑𝘾 𝘼𝙂𝙍 𝙀 𝙐𝙈 𝙏𝘼𝙊 𝙎𝙊𝙉𝙃𝘼𝘿𝙊 𝘼𝘿𝙈𝙄𝙉!!!😳 (+_+)`, mentioned, true)
						client.groupMakeAdmin(from, mentioned)
					}
					break	
			     	case 'kick':
					...
					if (!isGroupAdmins) return reply(mess.only.admin)
					if (!isBotGroupAdmins) return reply(mess.only.Badmin)
					if (mek.message.extendedTextMessage === undefined || mek.message.extendedTextMessage === null) return reply('𝙈𝘼𝙍𝘾𝘼 𝘼𝙇𝙂𝙐𝙀𝙈?!')
					mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
					if (mentioned.length > 1) {
						teks = ''
						for (let _ of mentioned) {
						...
						mentions(` @${mentioned[0].split('@')[0]}𝙁𝙊𝙄 𝘽𝘼𝙉𝙄𝘿𝙊 𝙎𝙆𝙎𝙆𝙎𝙆𝙎𝙆𝙆𝙎!! 🏃`, mentioned, true)
						client.groupRemove(from, mentioned)
					}
					break
				case 'listadmin':
					if (!isGroup) return reply(mess.only.group)
					teks = `𝙇𝙄𝙎𝙏𝘼 𝘿𝙀 𝘼𝘿𝙈 𝘽𝙍𝘼𝘽𝙐𝙎😎!! *${groupMetadata.subject}*\n𝗧𝗼𝘁𝗮𝗹 : ${groupAdmins.length}\n\n`
					no = 0
				...
				case 'simih':
					...
					if (Number(args[0]) === 1) {
						if (isSimi) return reply('𝙅𝘼 𝘼𝙏𝙄𝙑𝙊 !!!')
						samih.push(from)
						...
						samih.splice(from, 1)
						fs.writeFileSync('./src/simi.json', JSON.stringify(samih))
						reply('❬ 𝘽𝙀𝙈 𝙎𝙐𝘾𝙀𝘿𝙄𝘿𝙊❭ 𝘼𝙏𝙄𝙑𝙀 𝙊𝙎 𝙍𝙀𝘾𝙐𝙍𝙎𝙊𝙎 𝘿𝙊 𝙎𝙄𝙈𝙄 𝙉𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊')
					} else {
				...
				case 'nsfw':
					...
					if (args.length < 1) return reply('Boo :𝘃')
					if (Number(args[0]) === 1) {
						if (isNsfw) return reply('𝙅𝘼 𝘼𝙏𝙄𝙑𝙊??𝗳 !!')
						nsfw.push(from)
						...
						nsfw.splice(from, 1)
						fs.writeFileSync('./src/nsfw.json', JSON.stringify(nsfw))
						reply('❬ 𝙎𝙐𝘾𝙀𝙎𝙎𝙊 ❭ 𝘼𝙏𝙄𝙑𝙀 𝙊𝙎 𝙍𝙀𝘾𝙐𝙍𝙎𝙊𝙎 𝘿𝙊 𝙎𝙄𝙈𝙄 𝙉𝙀𝙎𝙏𝙀 𝙂𝙍𝙐𝙋𝙊')
					} else {
						reply(' *Ketik perintah 1 untuk mengaktifkan, 0 untuk menonaktifkan* \n𝗰𝗼𝗻𝘁𝗼𝗵: 𝗻𝘀𝗳𝘄 𝟭')
					}
					break
				case 'welcome':
					...
					if (args.length < 1) return reply('Boo :𝘃')
					if (Number(args[0]) === 1) {
						if (isWelkom) return reply('𝙅𝘼 𝘼𝙏𝙄𝙑𝙊 !!!')
						welkom.push(from)
						fs.writeFileSync('./src/welkom.json', JSON.stringify(welkom))
						reply('❬ 𝙎𝙐𝘾𝙀𝙎𝙎𝙊 ❭ 𝘼𝙩𝙞𝙫𝙚 𝙤 𝙧𝙚𝙘𝙪𝙧𝙨𝙤 𝙙𝙚 𝙗𝙤𝙖𝙨-𝙫𝙞𝙣𝙙𝙖𝙨  𝙚 𝙨𝙖𝙞𝙙𝙖𝙨 𝙙𝙚𝙨𝙨𝙚 𝙜𝙧𝙪𝙥𝙤.') 
					} else if (Number(args[0]) === 0) {
